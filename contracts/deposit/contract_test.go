...
func TestRegister_Below1Quanta(t *testing.T) {
	...
	_, err = testAccount.Contract.Deposit(testAccount.TxOpts, pubKeys[0].Marshal(), depositDataItems[0].WithdrawalRecipient, depositDataItems[0].Signature, depositDataRoot)
