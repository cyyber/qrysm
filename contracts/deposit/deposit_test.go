...
func TestDepositInput_GeneratesPb(t *testing.T) {
	...
	withdrawalAddr, err := common.NewAddressFromString("Q0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef")
	require.NoError(t, err)
...
func TestWithdrawalCredentialsAddress(t *testing.T) {
	...
	tests := []tc{
		...
		},
		{
			...
			addrHex: "Q0000000000000000000000000000000000112233445566778899aabbccddeeff00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff",
		},
		{
			name:    "all 0xff",
