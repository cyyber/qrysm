...
func TestStore_ProposerSettings_ReadAndWrite(t *testing.T) {
	recipient0, err := common.NewAddressFromString("Q50155530fCE8A85Ec7055a5F8B2be214B3daEFd300000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
	recipient1, err := common.NewAddressFromString("Q6e35733c5af9B61374A128e6F85f553aF09ff89A00000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
	recipient2, err := common.NewAddressFromString("Q9995733c5af9B61374A128e6F85f553aF09ff89B00000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
