...
func TestStore_ProposerSettings_ReadAndWrite(t *testing.T) {
	recipient0, err := common.NewAddressFromString("Q0000000000000000000000000000000000000000000000000000000050155530fCE8A85Ec7055a5F8B2be214B3daEFd3")
	require.NoError(t, err)
	recipient1, err := common.NewAddressFromString("Q000000000000000000000000000000000000000000000000000000006e35733c5af9B61374A128e6F85f553aF09ff89A")
	require.NoError(t, err)
	recipient2, err := common.NewAddressFromString("Q000000000000000000000000000000000000000000000000000000009995733c5af9B61374A128e6F85f553aF09ff89B")
	require.NoError(t, err)
