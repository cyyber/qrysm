...
func TestServer_ListFeeRecipientByPubkey(t *testing.T) {
	...
	require.NoError(t, err)
	recipient0, err := common.NewAddressFromString("Q046Fb65722E7b2455012bFeBf6177f1D2e9738D900000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
	recipient1, err := common.NewAddressFromString("QFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
	...
	tests := []struct {
		...
		},
		{
			...
			args: nil,
			want: &want{
				QRLAddress: "Q046Fb65722E7b2455012bFeBf6177f1D2e9738D900000000000000000000000000000000000000000000000000000000",
			},
			cached: &qrysmpb.FeeRecipientByPubKeyResponse{
...
func TestServer_FeeRecipientByPubkey(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:             "Q046Fb65722E7b2455012bFeBf6177f1D2e9738D900000000000000000000000000000000000000000000000000000000",
			proposerSettings: nil,
			want: &want{
				valQRLAddress: "Q046Fb65722E7b2455012bFeBf6177f1D2e9738D900000000000000000000000000000000000000000000000000000000",
			},
			wantErr: false,
			beaconReturn: &beaconResp{
				resp:  nil,
...
func TestServer_DeleteFeeRecipientByPubkey(t *testing.T) {
	...
	require.NoError(t, err)
	recipient0, err := common.NewAddressFromString("Q055Fb65722E7b2455012BFEBf6177F1D2e9738D500000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
	recipient1, err := common.NewAddressFromString("Q046Fb65722E7b2455012bFeBf6177f1D2e9738D900000000000000000000000000000000000000000000000000000000")
	require.NoError(t, err)
	type want struct {
		QRLAddress string
	}
