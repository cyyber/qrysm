...
func TestServer_ListFeeRecipientByPubkey(t *testing.T) {
	...
	require.NoError(t, err)
	recipient0, err := common.NewAddressFromString("Q00000000000000000000000000000000000000000000000000000000046Fb65722E7b2455012bFeBf6177f1D2e9738D9")
	require.NoError(t, err)
	recipient1, err := common.NewAddressFromString("Q00000000000000000000000000000000000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")
	require.NoError(t, err)
	...
	tests := []struct {
		...
		},
		{
			...
			args: nil,
			want: &want{
				QRLAddress: "Q00000000000000000000000000000000000000000000000000000000046Fb65722E7b2455012bFeBf6177f1D2e9738D9",
			},
			cached: &qrysmpb.FeeRecipientByPubKeyResponse{
...
func TestServer_FeeRecipientByPubkey(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:             "Q00000000000000000000000000000000000000000000000000000000046Fb65722E7b2455012bFeBf6177f1D2e9738D9",
			proposerSettings: nil,
			want: &want{
				valQRLAddress: "Q00000000000000000000000000000000000000000000000000000000046Fb65722E7b2455012bFeBf6177f1D2e9738D9",
			},
			wantErr: false,
			beaconReturn: &beaconResp{
				resp:  nil,
...
func TestServer_DeleteFeeRecipientByPubkey(t *testing.T) {
	...
	require.NoError(t, err)
	recipient0, err := common.NewAddressFromString("Q00000000000000000000000000000000000000000000000000000000055Fb65722E7b2455012BFEBf6177F1D2e9738D5")
	require.NoError(t, err)
	recipient1, err := common.NewAddressFromString("Q00000000000000000000000000000000000000000000000000000000046Fb65722E7b2455012bFeBf6177f1D2e9738D9")
	require.NoError(t, err)
	type want struct {
		QRLAddress string
	}
