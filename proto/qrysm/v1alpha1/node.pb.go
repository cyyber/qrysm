...
const file_proto_qrysm_v1alpha1_node_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/qrysm/v1alpha1/node.proto\x12\x13theqrl.qrl.v1alpha1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bproto/qrl/ext/options.proto\"&\n" +
	"\n" +
	"SyncStatus\x12\x18\n" +
	"\asyncing\x18\x01 \x01(\bR\asyncing\"\xc2\x01\n" +
	"\aGenesis\x12=\n" +
	"\fgenesis_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vgenesisTime\x128\n" +
	"\x18deposit_contract_address\x18\x02 \x01(\fR\x16depositContractAddress\x12>\n" +
	"\x17genesis_validators_root\x18\x03 \x01(\fB\x06\x8a\xb5\x18\x0232R\x15genesisValidatorsRoot\"?\n" +
	"\aVersion\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12\x1a\n" +
	"\bmetadata\x18\x02 \x01(\tR\bmetadata\"1\n" +
	"\x13ImplementedServices\x12\x1a\n" +
	"\bservices\x18\x01 \x03(\tR\bservices\"&\n" +
	"\vPeerRequest\x12\x17\n" +
	"\apeer_id\x18\x01 \x01(\tR\x06peerId\"8\n" +
	"\x05Peers\x12/\n" +
	"\x05peers\x18\x01 \x03(\v2\x19.theqrl.qrl.v1alpha1.PeerR\x05peers\"\xde\x01\n" +
	"\x04Peer\x12\x18\n" +
	...
	"\x03qnr\x18\x05 \x01(\tR\x03qnr\"S\n" +
	"\bHostData\x12\x1c\n" +
	"\taddresses\x18\x01 \x03(\tR\taddresses\x12\x17\n" +
	"\apeer_id\x18\x02 \x01(\tR\x06peerId\x12\x10\n" +
	"\x03qnr\x18\x03 \x01(\tR\x03qnr\"\xc9\x01\n" +
	"\x19ExecutionConnectionStatus\x12'\n" +
	"\x0fcurrent_address\x18\x01 \x01(\tR\x0ecurrentAddress\x128\n" +
	"\x18current_connection_error\x18\x02 \x01(\tR\x16currentConnectionError\x12\x1c\n" +
	"\taddresses\x18\x03 \x03(\tR\taddresses\x12+\n" +
	"\x11connection_errors\x18\x04 \x03(\tR\x10connectionErrors*7\n" +
	...
	"\n" +
	"CONNECTING\x10\x032\x90\a\n" +
	"\x04Node\x12l\n" +
	"\rGetSyncStatus\x12\x16.google.protobuf.Empty\x1a\x1f.theqrl.qrl.v1alpha1.SyncStatus\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/qrl/v1alpha1/node/syncing\x12f\n" +
	"\n" +
	"GetGenesis\x12\x16.google.protobuf.Empty\x1a\x1c.theqrl.qrl.v1alpha1.Genesis\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/qrl/v1alpha1/node/genesis\x12f\n" +
	"\n" +
	"GetVersion\x12\x16.google.protobuf.Empty\x1a\x1c.theqrl.qrl.v1alpha1.Version\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/qrl/v1alpha1/node/version\x12\x80\x01\n" +
	"\x17ListImplementedServices\x12\x16.google.protobuf.Empty\x1a(.theqrl.qrl.v1alpha1.ImplementedServices\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/qrl/v1alpha1/node/services\x12`\n" +
	"\aGetHost\x12\x16.google.protobuf.Empty\x1a\x1d.theqrl.qrl.v1alpha1.HostData\"\x1e\x82\xd3\xe4\x93\x02\x18\x12\x16/qrl/v1alpha1/node/p2p\x12g\n" +
	"\aGetPeer\x12 .theqrl.qrl.v1alpha1.PeerRequest\x1a\x19.theqrl.qrl.v1alpha1.Peer\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/qrl/v1alpha1/node/peer\x12a\n" +
	"\tListPeers\x12\x16.google.protobuf.Empty\x1a\x1a.theqrl.qrl.v1alpha1.Peers\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/qrl/v1alpha1/node/peers\x12\x98\x01\n" +
	"\x1cGetExecutionConnectionStatus\x12\x16.google.protobuf.Empty\x1a..theqrl.qrl.v1alpha1.ExecutionConnectionStatus\"0\x82\xd3\xe4\x93\x02*\x12(/qrl/v1alpha1/node/execution/connectionsB\x84\x01\n" +
	"\x17org.theqrl.qrl.v1alpha1B\tNodeProtoP\x01Z0github.com/theQRL/qrysm/proto/qrysm/v1alpha1;qrl\xaa\x02\x13TheQRL.QRL.v1alpha1\xca\x02\x13TheQRL\\QRL\\v1alpha1b\x06proto3"
