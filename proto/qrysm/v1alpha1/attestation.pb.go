...
const file_proto_qrysm_v1alpha1_attestation_proto_rawDesc = "" +
	"\n" +
	"&proto/qrysm/v1alpha1/attestation.proto\x12\x13theqrl.qrl.v1alpha1\x1a\x1bproto/qrl/ext/options.proto\"\xd5\x01\n" +
	"\vAttestation\x12Z\n" +
	...
	"\x10aggregator_index\x18\x01 \x01(\x04BE\x82\xb5\x18Agithub.com/theQRL/qrysm/consensus-types/primitives.ValidatorIndexR\x0faggregatorIndex\x12>\n" +
	"\taggregate\x18\x02 \x01(\v2 .theqrl.qrl.v1alpha1.AttestationR\taggregate\x121\n" +
	"\x0fselection_proof\x18\x03 \x01(\fB\b\x8a\xb5\x18\x044627R\x0eselectionProof\"\x99\x01\n" +
	"\"SignedAggregateAttestationAndProof\x12K\n" +
	"\amessage\x18\x01 \x01(\v21.theqrl.qrl.v1alpha1.AggregateAttestationAndProofR\amessage\x12&\n" +
	"\tsignature\x18\x02 \x01(\fB\b\x8a\xb5\x18\x044627R\tsignature\"\xf8\x02\n" +
	...
	"\x0fcommittee_index\x18\x02 \x01(\x04BE\x82\xb5\x18Agithub.com/theQRL/qrysm/consensus-types/primitives.CommitteeIndexR\x0ecommitteeIndex\x122\n" +
	"\x11beacon_block_root\x18\x03 \x01(\fB\x06\x8a\xb5\x18\x0232R\x0fbeaconBlockRoot\x127\n" +
	"\x06source\x18\x04 \x01(\v2\x1f.theqrl.qrl.v1alpha1.CheckpointR\x06source\x127\n" +
	"\x06target\x18\x05 \x01(\v2\x1f.theqrl.qrl.v1alpha1.CheckpointR\x06target\"|\n" +
	"\n" +
	"Checkpoint\x12R\n" +
	"\x05epoch\x18\x01 \x01(\x04B<\x82\xb5\x188github.com/theQRL/qrysm/consensus-types/primitives.EpochR\x05epoch\x12\x1a\n" +
	"\x04root\x18\x02 \x01(\fB\x06\x8a\xb5\x18\x0232R\x04rootB\x8b\x01\n" +
	"\x17org.theqrl.qrl.v1alpha1B\x10AttestationProtoP\x01Z0github.com/theQRL/qrysm/proto/qrysm/v1alpha1;qrl\xaa\x02\x13TheQRL.QRL.v1alpha1\xca\x02\x13TheQRL\\QRL\\v1alpha1b\x06proto3"
