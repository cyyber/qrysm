...
const file_proto_qrysm_v1alpha1_validator_proto_rawDesc = "" +
	...
	"\x1bcurrent_duty_dependent_root\x18\x04 \x01(\fB\x06\x8a\xb5\x18\x0232R\x18currentDutyDependentRoot\x1a\xa4\x05\n" +
	"\x04Duty\x12c\n" +
	...
	"\x11is_sync_committee\x18\b \x01(\bR\x0fisSyncCommittee\"\xd6\x01\n" +
	"\fBlockRequest\x12O\n" +
