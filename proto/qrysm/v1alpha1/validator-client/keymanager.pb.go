...
const file_proto_qrysm_v1alpha1_validator_client_keymanager_proto_rawDesc = "" +
	"\n" +
	"6proto/qrysm/v1alpha1/validator-client/keymanager.proto\x12\x1ctheqrl.validator.accounts.v2\x1a\x1bproto/qrl/ext/options.proto\x1a&proto/qrysm/v1alpha1/attestation.proto\x1a'proto/qrysm/v1alpha1/beacon_block.proto\x1a'proto/qrysm/v1alpha1/beacon_state.proto\x1a)proto/qrysm/v1alpha1/sync_committee.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"N\n" +
	"\x16ListPublicKeysResponse\x124\n" +
	"\x16validating_public_keys\x18\x01 \x03(\fR\x14validatingPublicKeys\"\xa3\t\n" +
	"\vSignRequest\x12\x1d\n" +
	"\n" +
	"public_key\x18\x01 \x01(\fR\tpublicKey\x12!\n" +
	"\fsigning_root\x18\x02 \x01(\fR\vsigningRoot\x12)\n" +
	"\x10signature_domain\x18\x03 \x01(\fR\x0fsignatureDomain\x12Q\n" +
	"\x10attestation_data\x18e \x01(\v2$.theqrl.qrl.v1alpha1.AttestationDataH\x00R\x0fattestationData\x12z\n" +
	"\x1faggregate_attestation_and_proof\x18f \x01(\v21.theqrl.qrl.v1alpha1.AggregateAttestationAndProofH\x00R\x1caggregateAttestationAndProof\x128\n" +
	"\x04exit\x18g \x01(\v2\".theqrl.qrl.v1alpha1.VoluntaryExitH\x00R\x04exit\x12Q\n" +
	"\x04slot\x18h \x01(\x04B;\x82\xb5\x187github.com/theQRL/qrysm/consensus-types/primitives.SlotH\x00R\x04slot\x12T\n" +
	"\x05epoch\x18i \x01(\x04B<\x82\xb5\x188github.com/theQRL/qrysm/consensus-types/primitives.EpochH\x00R\x05epoch\x12w\n" +
	"\x1esync_aggregator_selection_data\x18j \x01(\v20.theqrl.qrl.v1alpha1.SyncAggregatorSelectionDataH\x00R\x1bsyncAggregatorSelectionData\x12a\n" +
	"\x16contribution_and_proof\x18k \x01(\v2).theqrl.qrl.v1alpha1.ContributionAndProofH\x00R\x14contributionAndProof\x127\n" +
	"\x17sync_message_block_root\x18l \x01(\fH\x00R\x14syncMessageBlockRoot\x12R\n" +
	"\fregistration\x18m \x01(\v2,.theqrl.qrl.v1alpha1.ValidatorRegistrationV1H\x00R\fregistration\x12E\n" +
	"\n" +
	"block_zond\x18n \x01(\v2$.theqrl.qrl.v1alpha1.BeaconBlockZondH\x00R\tblockZond\x12[\n" +
	"\x12blinded_block_zond\x18o \x01(\v2+.theqrl.qrl.v1alpha1.BlindedBeaconBlockZondH\x00R\x10blindedBlockZond\x12^\n" +
	"\fsigning_slot\x18\x04 \x01(\x04B;\x82\xb5\x187github.com/theQRL/qrysm/consensus-types/primitives.SlotR\vsigningSlotB\b\n" +
	"\x06object\"\xb5\x01\n" +
	"\fSignResponse\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\fR\tsignature\x12I\n" +
	"\x06status\x18\x02 \x01(\x0e21.theqrl.validator.accounts.v2.SignResponse.StatusR\x06status\"<\n" +
	"\x06Status\x12\v\n" +
	...
	"\n" +
	"\x06FAILED\x10\x03\"\x83\x01\n" +
	"\x15ProposerOptionPayload\x12#\n" +
	"\rfee_recipient\x18\x01 \x01(\tR\ffeeRecipient\x12E\n" +
	"\abuilder\x18\x02 \x01(\v2+.theqrl.validator.accounts.v2.BuilderConfigR\abuilder\"\x9c\x01\n" +
	"\rBuilderConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12Y\n" +
	"\tgas_limit\x18\x02 \x01(\x04B<\x82\xb5\x188github.com/theQRL/qrysm/consensus-types/validator.Uint64R\bgasLimit\x12\x16\n" +
	"\x06relays\x18\x03 \x03(\tR\x06relays\"\xe1\x02\n" +
	"\x17ProposerSettingsPayload\x12r\n" +
	"\x0fproposer_config\x18\x01 \x03(\v2I.theqrl.validator.accounts.v2.ProposerSettingsPayload.ProposerConfigEntryR\x0eproposerConfig\x12Z\n" +
	"\x0edefault_config\x18\x02 \x01(\v23.theqrl.validator.accounts.v2.ProposerOptionPayloadR\rdefaultConfig\x1av\n" +
	"\x13ProposerConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12I\n" +
	"\x05value\x18\x02 \x01(\v23.theqrl.validator.accounts.v2.ProposerOptionPayloadR\x05value:\x028\x012\xa0\x02\n" +
	"\fRemoteSigner\x12\x8e\x01\n" +
	"\x18ListValidatingPublicKeys\x12\x16.google.protobuf.Empty\x1a4.theqrl.validator.accounts.v2.ListPublicKeysResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/accounts/v2/remote/accounts\x12\x7f\n" +
	"\x04Sign\x12).theqrl.validator.accounts.v2.SignRequest\x1a*.theqrl.validator.accounts.v2.SignResponse\" \x82\xd3\xe4\x93\x02\x1a\"\x18/accounts/v2/remote/signB\xbe\x01\n" +
	" org.theqrl.validator.accounts.v2B\x0fKeymanagerProtoP\x01ZIgithub.com/theQRL/qrysm/proto/qrysm/v1alpha1/validator-client;validatorpb\xaa\x02\x1cTheQRL.Validator.Accounts.V2\xca\x02\x1cTheQRL\\Validator\\Accounts\\V2b\x06proto3"
