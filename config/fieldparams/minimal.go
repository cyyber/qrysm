...
const (
	...
	MLDSA87SignatureLength                = cryptomldsa87.SignatureSize // MLDSA87SignatureLength defines the byte length of a ML-DSA-87 signature.
	MLDSA87PubkeyLength                   = cryptomldsa87.PublicKeySize // MLDSA87PubkeyLength defines the byte length of a ML-DSA-87 public key.
