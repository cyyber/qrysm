...
type BeaconChainConfig struct {
	...
	GenesisDelay                         uint64           `yaml:"GENESIS_DELAY" spec:"true"`                   // GenesisDelay is the minimum number of seconds to delay starting QRL beacon chain genesis. Must be at least 1 second.
	...
	QRLBurnAddress         string         // QRLBurnAddress is the zero address used to burn fees in that network.
