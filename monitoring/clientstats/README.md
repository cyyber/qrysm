...
|client_name                        |string       |beaconnode, validator|hard-coded to "qrysm"                                                    |Name of the client type. Ex: qrysm                                                                                                            |
...
|sync_execution_connected                |bool         |beaconchain          |prom: execution_chain_sync_execution_connected                                       |Whether or not the beacon chain node is connected to a _synced_ execution node                                                                                               |
|sync_consensus_synced                   |bool         |beaconchain          |prom: beacon_clock_time_slot (true if this equals prom: beacon_head_slot)|Whether or not the beacon chain node is in sync with the beacon chain network                                                                                           |
