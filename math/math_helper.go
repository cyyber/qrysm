// Package math includes important helpers for QRL consensus such as fast integer square roots.
package math
...
func init() {
	// The Int function assumes that the operating system is 64 bit. QRL consensus uses
	// 64 bit values almost exclusively so 64 bit OS requirement should
