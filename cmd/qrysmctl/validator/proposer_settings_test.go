...
const testFeeRecipientAddress = "Q1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"
...
func getValidatorHappyPathTestServer(t *testing.T) *httptest.Server {
	...
	address1 := testFeeRecipientAddress
...
func TestGetProposerSettings(t *testing.T) {
	...
	defaultfeerecipient := testFeeRecipientAddress
...
func TestValidateValidateIsExecutionAddress(t *testing.T) {
	validAddress := testFeeRecipientAddress
	t.Run("Happy Path", func(t *testing.T) {
		err := validateIsExecutionAddress(validAddress)
		require.NoError(t, err)
	})
	t.Run("Too Long", func(t *testing.T) {
		err := validateIsExecutionAddress(validAddress + "1")
		require.ErrorContains(t, "no default address entered", err)
	})
	t.Run("Too Short", func(t *testing.T) {
		err := validateIsExecutionAddress(validAddress[:len(validAddress)-1])
		require.ErrorContains(t, "no default address entered", err)
	})
