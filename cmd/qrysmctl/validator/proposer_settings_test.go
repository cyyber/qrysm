...
func getValidatorHappyPathTestServer(t *testing.T) *httptest.Server {
	...
	address1 := "Q00000000000000000000000000000000000000000000000000000000b698D697092822185bF0311052215d5B5e1F3944"
...
func TestGetProposerSettings(t *testing.T) {
	...
	defaultfeerecipient := "Q00000000000000000000000000000000000000000000000000000000b698D697092822185bF0311052215d5B5e1F3944"
...
func TestValidateValidateIsExecutionAddress(t *testing.T) {
	t.Run("Happy Path", func(t *testing.T) {
		err := validateIsExecutionAddress("Q00000000000000000000000000000000000000000000000000000000b698D697092822185bF0311052215d5B5e1F3933")
		require.NoError(t, err)
	})
