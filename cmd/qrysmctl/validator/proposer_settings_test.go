...
func getValidatorHappyPathTestServer(t *testing.T) *httptest.Server {
	...
	address1 := "Qb698D697092822185bF0311052215d5B5e1F394400000000000000000000000000000000000000000000000000000000"
...
func TestGetProposerSettings(t *testing.T) {
	...
	defaultfeerecipient := "Qb698D697092822185bF0311052215d5B5e1F394400000000000000000000000000000000000000000000000000000000"
...
func TestValidateValidateIsExecutionAddress(t *testing.T) {
	t.Run("Happy Path", func(t *testing.T) {
		err := validateIsExecutionAddress("Qb698D697092822185bF0311052215d5B5e1F393300000000000000000000000000000000000000000000000000000000")
		require.NoError(t, err)
	})
