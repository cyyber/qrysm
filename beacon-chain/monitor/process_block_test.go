...
func TestProcessProposedBlock(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantedErr: "\"Proposed beacon block was included\" BalanceChange=100000000 BlockRoot=0x68656c6c6f2d NewBalance=40000000000000 ParentRoot=0x68656c6c6f2d ProposerIndex=25 Slot=6 Version=0 prefix=monitor",
		},
		{
...
func TestProcessBlock_AllEventsTrackedVals(t *testing.T) {
	...
	wanted1 := fmt.Sprintf("\"Proposed beacon block was included\" BalanceChange=100000000 BlockRoot=%#x NewBalance=40000000000000 ParentRoot=0xb88dfbae9294 ProposerIndex=112 Slot=1 Version=0 prefix=monitor", bytesutil.Trunc(root[:]))
