...
func TestProcessBlock_AllEventsTrackedVals(t *testing.T) {
	...
	wanted1 := fmt.Sprintf("\"Proposed beacon block was included\" BalanceChange=100000000 BlockRoot=%#x NewBalance=40000000000000 ParentRoot=0xb14e0cf69333 ProposerIndex=67 Slot=1 Version=0 prefix=monitor", bytesutil.Trunc(root[:]))
