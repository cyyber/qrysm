...
func TestServer_GetBlockHeader(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		assert.Equal(t, "0x3ccd0f110e1eff08d8fca7ab212788c80a2670d3603d0d1497f4be571e1a86d1", resp.Data.Root)
		...
		assert.Equal(t, "0xc0651521102e20ffab8df8cb59fdbeaec6758f48f5b4fc86b88d3beec58afa4b", resp.Data.Header.Message.BodyRoot)
