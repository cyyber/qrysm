...
func TestPrepareBeaconProposer(t *testing.T) {
	validFeeRecipient := "Qabcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789"
	tests := []struct {
		name    string
		...
		{
			name: "invalid fee recipient syntax",
			request: []*shared.FeeRecipient{{
				FeeRecipient:   validFeeRecipient[:len(validFeeRecipient)-1] + "z",
				ValidatorIndex: "1",
			},
			},
			code:    http.StatusBadRequest,
			wantErr: "Fee Recipient is invalid",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
`
	...
	invalidBeaconCommitteeContribution = `[
  {
	...
	registrations = `[{
    "message": {
      "fee_recipient": "Qabcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789",
      "gas_limit": "1",
      "timestamp": "1",
