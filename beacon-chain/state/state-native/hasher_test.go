...
func TestComputeFieldRootsWithHasher_Zond(t *testing.T) {
	...
	expected := [][]byte{
		...
		{0xf9, 0x11, 0x2c, 0xc2, 0x71, 0x70, 0xde, 0x47, 0x26, 0xeb, 0x26, 0xd4, 0xa4, 0xe8, 0x68, 0xb, 0x16, 0xa2, 0x6e, 0x52, 0x54, 0xe, 0x5c, 0x83, 0x17, 0x3, 0xea, 0xdd, 0xd5, 0xa7, 0xb2, 0x3f},
		{0xf8, 0xa1, 0xe2, 0x1, 0x25, 0x2c, 0x31, 0x4d, 0xe1, 0xee, 0x3e, 0xe2, 0x9, 0xf5, 0x18, 0xe0, 0x8f, 0xd3, 0xdf, 0x2b, 0xa, 0x8d, 0xd0, 0x47, 0x5f, 0x48, 0x29, 0x2b, 0xfb, 0xd3, 0x3, 0x5e},
		{0x3c, 0xdc, 0x84, 0x2c, 0x73, 0x11, 0x8b, 0x3a, 0xac, 0x11, 0x1d, 0x15, 0xbf, 0xc, 0xf8, 0x2a, 0x65, 0xd9, 0xc6, 0x91, 0x46, 0x79, 0x1a, 0xf3, 0xe3, 0xbe, 0x73, 0x93, 0xc5, 0x3e, 0x23, 0x20},
...
func validator() *qrysmpb.Validator {
	pk := bytesutil.PadTo([]byte("public"), fieldparams.MLDSA87PubkeyLength)
...
func syncCommittee(prefix string) *qrysmpb.SyncCommittee {
	...
	for i := range pubkeys {
		pubkeys[i] = bytesutil.PadTo([]byte(prefix+"pubkey"), fieldparams.MLDSA87PubkeyLength)
	}
