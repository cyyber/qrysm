...
func TestCreateAndCall(t *testing.T) {
	...
	{ // Verify CREATE + CALL
		...
		exp := "9f6005600055606060005360006001536054600253606060035360006004536052600553606060065360206007536060600853600060095360f3600a53600b600060005260f3604053604160006000f060006000600060006000a55af15050"
		if got := p.Hex(); got != exp {
	...
	{ // Verify CREATE + DELEGATECALL
		...
		exp := "9f6005600055606060005360006001536054600253606060035360006004536052600553606060065360206007536060600853600060095360f3600a53600b600060005260f3604053604160006000f06000600060006000a45af45050"
		if got := p.Hex(); got != exp {
	...
	{ // Verify CREATE2 + STATICCALL
		...
		exp := "9f6005600055606060005360006001536054600253606060035360006004536052600553606060065360206007536060600853600060095360f3600a53600b600060005260f36040536000604160006000f56000600060006000a45afa5050"
		if got := p.Hex(); got != exp {
			t.Fatalf("2: got %v expected %v", got, exp)
		}
	}
